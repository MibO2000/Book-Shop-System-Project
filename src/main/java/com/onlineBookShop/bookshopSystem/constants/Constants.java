...
public class Constants {
    //book repo
    public static final String SORTING_BOOKS_ASC = "SELECT * FROM Book AS b ORDER BY b.name ASC";
    public static final String SORTING_BOOKS_DESC = "SELECT * FROM Book AS b ORDER BY b.name DESC";
